	...
	return (
		<label className="cursor-pointer custom-checkbox">
			...
			<div className="flex items-center gap-x-3">
				<div className="bg-white w-full h-full rounded-md custom-checkbox-square flex items-center justify-center">
					<svg
						width="16"
						height="17"
						viewBox="0 0 16 17"
				...
				<label htmlFor={props.name} className="text-left text-sm cursor-pointer">
					{text}
				</label>
			</div>
		</label>
